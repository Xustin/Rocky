...
\033[1;92m•◈•-----------------•◈•\033[1;97mJustinImran\033[1;91m•◈•------------•◈•"""
jalan("\033[1;91m╭━━━━━━━╮")
jalan("\033[1;91m┃       ● ══    ┃")
jalan("\033[1;91m┃███████┃")
jalan("\033[1;91m┃███████┃")
...
jalan("\033[1;91m┃         ○        ┃")
jalan("\033[1;91m╰━━━━━━━╯")
jalan("\033[1;94m----------------T00L UPDATE DONE BY JUSTIN-------")
print "\033[1;95m-----------\033[1;93mJusTin Imran-------------"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:justin
	    time.sleep(2)
            loop = 'false'
        else:
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.facebook.com/X.Zack.75
...
def pilih_super():
	...
	if peak =="":
		...
		print "\033[1;94m•◈•----------------•◈•\033[1;95mJustinVau\033[1;93m•◈•-------------------•◈•"
		try:
	...
	print "\033[1;97m-----------------\033[1;93mJusTin Imran\033[1;97m-----------------------"
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;97m----------------\033[1;95mJusTin Imran\033[1;97m-------------------"
	print "  \033[1;93m-------Creadit to me [JusTin]--------" #Dev:justin
	print '\033[1;94mProcess Has Been Completed Press->Ctrl+Z[<-πNext Type (python2 Imran.py)↩\033[1;97m....'
...
\033[1;91m----
\033[1;92m ....Thanksme By Following my Facebook JusTin Imran..(9 Subs Done ).... \033[1;95m :
\033[1;93m----'
                Contact me on Facebook
              \033[1;91m JusTin Imran """
